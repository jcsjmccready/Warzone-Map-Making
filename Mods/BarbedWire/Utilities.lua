...
--Returns the number of a trap's pieces (Primed or Triggered) a player currently owns across the whole map.
--Used generically for both Barbed Wire and Caltrop - pass whichever trap's structure IDs.
---@param standing GameStanding
---@param playerID PlayerID
---@param primedStructureID string
---@param triggeredStructureID string
function CountPlayerTrapPieces(standing, playerID, primedStructureID, triggeredStructureID)
    local count = 0;
...
-- Copied from OrderNeutral/Utilities.lua
