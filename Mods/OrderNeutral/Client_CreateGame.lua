...
function Client_CreateGame(settings, alert)
    if (Mod.Settings.NeutralArmyGivesVision and Mod.Settings.VisionMethodFreeReconCard and (settings.Cards == nil or settings.Cards[WL.CardID.Reconnaissance] == nil)) then
