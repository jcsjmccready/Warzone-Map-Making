...
THIS_MOD_KEY = "IntermodTesterB";
OTHER_MOD_KEY = "IntermodTesterA";
...
---Payload of the order made by this mod's menu, it asks this mod to send a test order to itself
SEND_SELF_ORDER_PAYLOAD = THIS_MOD_KEY .. "_SendSelfTestOrder";
